...
CREATE TABLE `destoon_company` (
  ...
  `linkurl` varchar(255) NOT NULL default '',
  `legal` varchar(30) NOT NULL default '',
  `legal_mobile` varchar(50) NOT NULL default '',
  `license_thumb` varchar(255) NOT NULL default '',
  `license_expire` varchar(4) NOT NULL default '',
  PRIMARY KEY  (`userid`),
  KEY `domain` (`domain`),
  KEY `vip` (`vip`),
  KEY `areaid` (`areaid`),
...
DROP TABLE IF EXISTS `destoon_invite_customer`;
